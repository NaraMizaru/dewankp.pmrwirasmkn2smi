    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 class="text-primary">Kelola Anggota</h1>
            </div>
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                          ...
                          <h4>Daftar Anggota Pengkacuan</h4>
                          @elseif (Request::query('group_by') == 'tidak-pengkacuan')
                          <h4>Daftar Anggota Tidak Pengkacuan</h4>
                        @endif
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                @if (auth()->user()->role == 'admin')
                                                    <form
                                                        ...
                                                        <td>
                                                            <button
                                                                class="btn {{ $item->status == 'tidak pengkacuan' ? 'btn-info' : 'btn-dark' }}"><i
