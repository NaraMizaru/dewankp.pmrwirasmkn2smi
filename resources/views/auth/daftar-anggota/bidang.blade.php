    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 class="text-primary">Anggota Bidang</h1>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Daftar Anggota {{ $thisBidang->name }}</h4>
                            </div>
                            <div class="card-body">
                                {{ $anggotaBidangCount }}
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Daftar Anggota By Bidang</h4>
                        </div>
                        <div class="card-body">
                            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'pengurus' && auth()->user()->pengurus->type == 'inti 6')
                            <a href="{{ route('download.daftar-anggota-by.pdf', ['bidang' => $thisBidang->slug]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($anggota as $item)
                                            <tr>
                                                ...
                                                @if (auth()->user()->role == 'admin')
                                                    <td>
                                                        <form action="{{ route('anggota.upStatus', $item->user->username) }}"
                                                            method="POST">
                                                            @csrf
