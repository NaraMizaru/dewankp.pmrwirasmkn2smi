...
@section('title', 'Daftar Anggota ' . $thisKelas->name)
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 class="text-primary">Anggota Kelas</h1>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Daftar Anggota {{ $thisKelas->name }}</h4>
                            </div>
                            <div class="card-body">
                                {{ $anggotaKelasCount }}
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Daftar Anggota By Kelas</h4>
                        </div>
                        <div class="card-body">
                            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'pengurus' && auth()->user()->pengurus->type == 'inti 6')
                            <a href="{{ route('download.daftar-anggota-by.pdf', ['kelas' => $thisKelas->slug]) }}"
                                        ...
                                        @foreach ($anggota as $item)
                                            <tr>
                                                ...
                                                @if (auth()->user()->role == 'admin')
                                                    <td>
                                                        <form
                                                            action="{{ route('anggota.upStatus', $item->user->username) }}"
                                                            method="POST">
                                                            @csrf
