            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{ route('anggota.edit', $anggota->user->username) }}" method="POST"
                            enctype="multipart/form-data" class="needs-validation" novalidate=''>
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 text-center">
                                        @if ($anggota->user->profile_image == null)
                                            <img src="{{ asset('img/avatar/avatar-1.png') }}" width="150" height="150"
                                                alt="" class="rounded-circle mr-2" id="profile-image">
                                        @else
                                            <img src="{{ asset('storage/' . $anggota->user->profile_image) }}" width="150"
